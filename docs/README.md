...
> Datafusion Ray was just writing the output to disk in Arrow IPC format, and this means that Datafusion Ray was not truly distributed because it requires a shared file system.

Now, it's now able to use the Ray object store instead, as
proposed [here](https://github.com/datafusion-contrib/ray-sql/issues/22) and implemented [here](https://github.com/datafusion-contrib/ray-sql/pull/33).
